      ...
      <div className="bg-white">
        <div className="relative overflow-hidden bg-gray-50">
          ...
          <main className="py-20 max-w-7xl mx-auto ">
            ...
            { loading ? (
              <div className="border bg-white border-gray-200 shadow rounded-md w-full mx-auto mt-8">
                <div className="animate-pulse min-w-0 flex-1 sm:flex sm:items-center sm:justify-between px-4 py-4 flex sm:px-6">
                  <div className="flex-1 space-y-4 py-1">
                    <div className="flex">
                      <div className="w-20 h-2 bg-slate-200 rounded"></div>
                      <div className="w-36 h-2 bg-slate-200 rounded ml-4"></div>
                    </div>
                    <div className="flex">
                      <div className="w-60 h-2 bg-slate-200 rounded"></div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="w-28 h-7 bg-slate-200 rounded ml-5"></div>
                  </div>
                </div>
              </div>
            ) : error ? (
